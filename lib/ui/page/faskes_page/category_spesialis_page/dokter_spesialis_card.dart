...
Widget dokterSpesialisCard({
  required Dokter dokter,
  required WidgetRef ref,
}) {
  ref.read(searchJarakFaskesProvider(dokter.tempatPraktik).notifier);

  final jarakState = ref.watch(searchJarakFaskesProvider(dokter.tempatPraktik));
