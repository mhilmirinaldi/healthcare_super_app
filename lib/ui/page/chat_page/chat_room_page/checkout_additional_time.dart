...
class CheckoutAdditionalTimePage extends ConsumerStatefulWidget {
  final Transaksi transaksi;

  const CheckoutAdditionalTimePage({super.key, required this.transaksi});

  @override
  ConsumerState<CheckoutAdditionalTimePage> createState() =>
      _CheckoutAdditionalTimePageState();
}

class _CheckoutAdditionalTimePageState
    extends ConsumerState<CheckoutAdditionalTimePage> {
