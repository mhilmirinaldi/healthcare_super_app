...
class GetDokterByKategori implements UseCase<Result<List<Dokter>>, GetDokterByKategoriParam>{
  ...
  @override
  Future<Result<List<Dokter>>> call(GetDokterByKategoriParam params) async {
